<?php
//
// Definition of yRSSExportItem class
//
...
/*!
  \class yRSSExportItem ezrssexportitem.php
...
class yRSSExportItem extends eZPersistentObject
{

    /*!
     Initializes a new RSSExportItem.
    */
    function yRSSExportItem( $row )
    {
    ...
    static function definition()
    {
        return array( "fields" => array( "id" => array( 'name' => 'ID',
                                         ...
                                         'author' => array( 'name' => 'author',
                                                                 ...
                                                                 'default' => '',
                                                                 'required' => true ),
                                         'yfulltext' => array( 'name' => 'yfulltext',
                                                                 'datatype' => 'string',
                                                                 'default' => '',
                                                                 'required' => true ),
                      ...
                      "increment_key" => "id",
                      "class_name" => "yRSSExportItem",
                      "name" => "ezyrss_export_item" );
    }

    /*!
     \static
     Creates a new RSS Export Item
     \param yRSSExport objcted id. (The RSSExport this item belongs to)
    ...
    */
    ...
    {
        return eZPersistentObject::fetchObject( yRSSExportItem::definition(),
                                                null,
                                                array( "id" => $id,
                                                       'status' => $status ),
                                                $asObject );
    ...
    */
    static function fetchFilteredList( $cond, $asObject = true, $status = yRSSExport::STATUS_VALID )
    {
        return eZPersistentObject::fetchObjectList( yRSSExportItem::definition(),
