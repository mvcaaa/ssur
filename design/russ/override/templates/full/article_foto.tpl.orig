...
{/if}
	    ...
	    {if $image.has_content}
                <div class="attribute-image">
                    {attribute_view_gui attribute=$image image_class=onephoto_full}
                </div>
            {/if}
        {/if}
...
*}
		<div id="fb-root" style="margin-top: 10px;"></div><script src="http://connect.facebook.net/ru_RU/all.js#appId=205210852866905&amp;xfbml=1"></script>

<fb:comments href="{$node.url_alias|ezurl}" num_posts="20" width="700" colorscheme="light"></fb:comments>
	</div>
</div>
