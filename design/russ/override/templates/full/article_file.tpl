...
{/if}
        ...
        {section show=$node.data_map.body.content.is_empty|not}
    	    ...
    	    {section show=$node.data_map.file.has_content}
<p><a href={concat("content/download/",$node.data_map.file.contentobject_id,"/",$node.data_map.file.id,"/file/",$node.data_map.file.content.original_filename)|ezurl}>Скачать <img src={"images/icons/pdf_icon.gif"|ezdesign} width="21" height="22" border="0" alt="" align=absmiddle></a></p>
	        {/section}
            </div>
        {/section}
...
{*
	{if $node.object.data_map.see_also.has_content}
            <div class="attribute-topic">
