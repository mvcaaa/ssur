...
<tr>
	<td width="" id="td_hotcontent">
		<div id="hotcontent">{*{foreach $list_items as $child max 1}{/foreach} *}
{*** HOT ARTICLE ***}
...
<div class="content-view-line">
	...
	<td width="390" id="td_hotpic">{if $image.has_content}<div id="hotpic">{attribute_view_gui attribute=$image image_class=imagelarge}</div>{else}&nbsp;{/if}</td>
</tr>
<tr>
