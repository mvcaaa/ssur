...
{if $current_node.class_identifier|eq("article")}
<div class="adblock">
{sape_links('5')}
</div>
{/if}
...
<div class="content-view-line"> 
    <div class="class-article float-break"> 
	     <div class="attribute-image"> 
            <a href="http://www.gpf-yaroslavl.ru/ru/"><img src="/var/russ/storage/images/logo_forum.jpg" width="200" height="300"  style="border: 0px;" alt="" title="" /></a><br><br>
         </div> 
	</div>
</div>
</div>
